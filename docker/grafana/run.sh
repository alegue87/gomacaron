...
# customizations from https://volkovlabs.io/blog/how-to-customize-the-grafana-user-interface-8d70a42dc2b6/

# Update Title
sed -i 's|<title>\[\[.AppTitle\]\]</title>|<title>Moqui</title>|g' /usr/share/grafana/public/views/index.html

## Update Title
find /usr/share/grafana/public/build/ -name *.js -exec sed -i 's|AppTitle="Grafana"|AppTitle="Moqui"|g' {} \;
find /usr/share/grafana/public/build/ -name *.js -exec sed -i 's|alt="Grafana"|alt="Moqui"|g' {} \;


## Update Login Title
find /usr/share/grafana/public/build/ -name *.js -exec sed -i 's|LoginTitle="Welcome to Grafana"|LoginTitle="Welcome to Moqui"|g' {} \;

# icon
rm /usr/share/grafana/public/img/grafana_icon.svg
